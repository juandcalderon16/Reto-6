...
public class Automovil {
    ...
    public Automovil(String placa, String marca, int modelo, double kilometraje, String color, double precio, String descripcion, String vendedor) throws KilometrajeExcepcion {
        if(kilometraje<0){
